...
int main(int argc, char **argv)
{
  ...
  // Plan 1
  // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ROS_INFO("Plan 1: Set end effector target position");
  ...
  ROS_INFO("Plan 2: Set end effector target position");
  ...
  ROS_INFO("Plan 2: Move end effector to target position");
  group.move();
  sleep(4.0);
  ...
  // Plan 3
  // ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  ROS_INFO("Plan 3: Set end effector target position");
  geometry_msgs::Pose pose_target3;
  pose_target3.position.x = 0.8;
  pose_target3.position.y = 0.8;
