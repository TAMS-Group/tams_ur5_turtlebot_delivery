...
// Note that this topic may need to be remapped in the launch file
  ...
  shapes::Mesh* m = shapes::createMeshFromResource("file://"+path.string()+"/src/project15_gazebo/Media/models/Rest.dae");
  ...
  co.mesh_poses[0].position.x = 8.9;
  co.mesh_poses[0].position.y = 1;
  co.mesh_poses[0].position.z = 1;
  co.mesh_poses[0].orientation.w= 0;
  co.mesh_poses[0].orientation.x= 1.57;
  co.mesh_poses[0].orientation.y= 0.0;
  co.mesh_poses[0].orientation.z= -1.57;
